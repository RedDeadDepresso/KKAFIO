...
├── build_modpack_index.py           # Standalone maintainer tool — regenerates the modpack index JSONs
├── download_gui.py                  # Standalone script that downloads the MXU-KKAFIO GUI release
